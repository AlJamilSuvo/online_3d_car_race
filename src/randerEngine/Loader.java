...
public class Loader {
	...
	public RawModel loadToVAO(float[] verticesArray, float[] texturesArray, float[] normalsArray, int[] indicesArray) {
		int vaoID=createVAO();
		bindIndicesBuffer(indicesArray);
		storedDataInAttributeList(0,3,verticesArray);
		storedDataInAttributeList(1,2,texturesArray);
		storedDataInAttributeList(2,3,normalsArray);
		unbindVAO();
