...
public class Collision {
	...
	public static boolean testInterSection(EntityPack c0,Vector3f v0,Entity c1,Vector3f v1,float tMax){
		Vector3f v=new Vector3f();
		Vector3f.sub(v1, v0, v);
		tfirst=0;
		tlast=100000000;
	...
	public static boolean testInterSection(EntityPack c0,Vector3f v0,EntityPack c1,Vector3f v1,float tMax){
		Vector3f v=new Vector3f();
		Vector3f.sub(v1, v0, v);
		tfirst=0;
		tlast=100000000;
