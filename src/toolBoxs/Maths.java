...
public class Maths {
	...
	public static float getDistance(EntityPack entityPack, Entity entity) {
		float x=entityPack.getPosition().x-entity.getPosition().x;
		float y=entityPack.getPosition().y-entity.getPosition().y;
		float z=entityPack.getPosition().z-entity.getPosition().z;
		float distance=(float)Math.sqrt(x*x+y*y+z*z);
		return distance;
	}
}
